...
// include esp32_ping.hpp to occasioanly ping the router to check if ESP32 is still connected to WiFi
...
// 3. NETWORK:     #define how ESP32 will use the network
    ...
    #define HOSTNAME                                   "ESP32_oscilloscope"      // <- replace with your information,  max 32 bytes
...
#include "./servers/network.h"                      // fileSystem.hpp is needed prior to #including network.h if you want to store the default parameters
